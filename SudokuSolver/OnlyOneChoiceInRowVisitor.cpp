...
bool OnlyOneChoiceInRowVisitor::Visit(Grid& ioGrid) const
{
	...
	RowHolder rh1_2 = RegionHolder(ioGrid.Get_rN()).TopRow();
	RowHolder rh1_3 = RegionHolder(ioGrid.Get_rNE()).TopRow();
	LastCellFinder lcf1(rh1_1, rh1_2, rh1_3);
	success |= lcf1.fill();

	RowHolder rh2_1 = RegionHolder(ioGrid.Get_rNW()).MiddleRow();
	RowHolder rh2_2 = RegionHolder(ioGrid.Get_rN()).MiddleRow();
	RowHolder rh2_3 = RegionHolder(ioGrid.Get_rNE()).MiddleRow();
	LastCellFinder lcf2(rh2_1, rh2_2, rh2_3);
	success |= lcf2.fill();

	RowHolder rh3_1 = RegionHolder(ioGrid.Get_rNW()).BottomRow();
	RowHolder rh3_2 = RegionHolder(ioGrid.Get_rN()).BottomRow();
	...
	RowHolder rh4_2 = RegionHolder(ioGrid.Get_rC()).TopRow();
	RowHolder rh4_3 = RegionHolder(ioGrid.Get_rE()).TopRow();
	LastCellFinder lcf4(rh4_1, rh4_2, rh4_3);
	success |= lcf4.fill();

	RowHolder rh5_1 = RegionHolder(ioGrid.Get_rW()).MiddleRow();
	RowHolder rh5_2 = RegionHolder(ioGrid.Get_rC()).MiddleRow();
	RowHolder rh5_3 = RegionHolder(ioGrid.Get_rE()).MiddleRow();
	LastCellFinder lcf5(rh5_1, rh5_2, rh5_3);
	success |= lcf5.fill();
	
	RowHolder rh6_1 = RegionHolder(ioGrid.Get_rW()).BottomRow();
	RowHolder rh6_2 = RegionHolder(ioGrid.Get_rC()).BottomRow();
	...
	RowHolder rh7_2 = RegionHolder(ioGrid.Get_rS()).TopRow();
	RowHolder rh7_3 = RegionHolder(ioGrid.Get_rSE()).TopRow();
	LastCellFinder lcf7(rh7_1, rh7_2, rh7_3);
	success |= lcf7.fill();

	RowHolder rh8_1 = RegionHolder(ioGrid.Get_rSW()).MiddleRow();
	RowHolder rh8_2 = RegionHolder(ioGrid.Get_rS()).MiddleRow();
	RowHolder rh8_3 = RegionHolder(ioGrid.Get_rSE()).MiddleRow();
	LastCellFinder lcf8(rh8_1, rh8_2, rh8_3);
	success |= lcf8.fill();

	RowHolder rh9_1 = RegionHolder(ioGrid.Get_rSW()).BottomRow();
	RowHolder rh9_2 = RegionHolder(ioGrid.Get_rS()).BottomRow();
